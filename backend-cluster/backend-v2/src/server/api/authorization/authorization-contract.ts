...
/**
 * Authorization state whose lifetime is exactly one resolved request identity.
 * The singleton AuthorizationService never owns this memo.
 */
export class AuthorizationRequest {
  ...
  constructor(public readonly principal: Identity) {}

  public decisionFor(
    key: string,
    decide: () => Promise<AuthorizationDecision>,
  ): Promise<AuthorizationDecision> {
...
export const authorizationRequest = (
  principal: Identity,
): AuthorizationRequest => new AuthorizationRequest(principal);
