...
export const zh: typeof en = {
  ...
  discoverySearch: "搜索账本",
  discoveryClear: "清除搜索",
  discoveryOpen: "打开 {{name}}",
  discoveryStar: "收藏 {{name}}",
  discoveryUnstar: "取消收藏 {{name}}",
  discoveryPrivate: "私有",
  discoveryPublic: "公开",
  discoveryCurrent: "当前",
  discoveryLoading: "正在加载账本…",
  discoveryLoadMore: "加载更多",
  discoveryRetry: "重试",
  discoveryNoMatches: "没有匹配的账本。",
  discoveryEmpty_yours: "你的账本将显示在这里。可以先探索公开账本。",
  discoveryEmpty_starred: "收藏账本，下次即可在这里找到。",
  discoveryEmpty_explore: "未找到公开账本。",
  discoveryLoadError: "无法加载账本，请重试。",
  discoveryActionError: "操作未完成。请检查网络连接和账本访问权限后重试。",
  ledgerReadOnly: "此账本为只读。请选择你有编辑权限的账本进行修改。",
  ...
  mine: "我的",
  merchantsRecurringSection: "定期",
  merchantsRecurringBadge: "定期",
  merchantsCadenceWeekly: "每周",
  merchantsCadenceBiweekly: "每两周",
  merchantsCadenceMonthly: "每月",
  merchantsCadenceQuarterly: "每季",
  merchantsCadenceYearly: "每年",
  ...
  merchantDetailLoadError: "加载商户失败：",
  merchantDetailRetry: "重试",
  merchantDetailEmptyTitle: "没有交易",
  merchantDetailEmptyMessage: "没有与此商户完全匹配的交易。",
  merchantDetailLoadingMore: "加载更多…",
  setting: "设置",
  // mine
  reviewApp: "给个好评鼓励一下",
  helpCenter: "帮助中心",
  ...
  serverSettingsDescription:
    "连接到兼容的 Beancount.io 服务器。请只使用您信任的服务器；它将接收您的登录信息。",
  serverUrl: "服务器 URL",
  serverUrlHelper:
    "输入基础 URL，例如 https://ledger.example.com/。本地开发以外必须使用 HTTPS。",
  serverUrlEmpty: "请输入服务器 URL。",
  serverUrlInvalid: "请输入完整的 HTTP 或 HTTPS URL。",
  serverUrlCredentials: "服务器 URL 不能包含用户名或密码。",
  serverUrlQuery: "服务器 URL 不能包含查询参数或片段。",
  serverUrlInsecure: "请使用 HTTPS。HTTP 仅在开发版本中可用于 localhost。",
  testConnection: "测试连接",
  serverConnectionSuccess: "已连接到兼容的 Beancount.io 服务器。",
  serverConnectionTimeout: "服务器未及时响应。",
  serverConnectionUnreachable: "无法连接到该服务器。",
  serverConnectionIncompatible: "该服务器未提供所需的 Beancount.io API。",
  serverConnectionAdvisory: "您仍可保存此 URL，并在服务器可用时登录。",
  restoreDefaultServer: "恢复 Beancount.io 默认服务器",
  backToSignIn: "返回登录",
  signInFailed: "登录未能完成，请重试。",
  signUpFailed: "无法完成注册，请重试。",
  addTransaction: "添加事务",
  assets: "资产",
  expenses: "开支",
  income: "收入",
  ...
  ledgerEditorFileUnavailable: "该文件已不在账本中。",
  ledgerEditorBackToFiles: "返回文件",
  ...
  budgetPanelRowValue: "{{actual}} / {{budget}}，已用 {{percent}}%，{{status}}",
  ...
  createLedgerTitle: "新建账本",
  createLedgerSubmit: "创建",
  createLedgerName: "名称",
  createLedgerNamePlaceholder: "my-book",
  createLedgerNameRequired: "请输入账本名称。",
  createLedgerNameMaxLength: "名称不能超过 100 个字符。",
  createLedgerNameInvalid: "名称至少包含一个字母或数字。",
  createLedgerNameConflict: "已存在同名账本。",
  createLedgerSlugPreview: "将创建为 {{slug}}",
  createLedgerDescription: "描述",
  createLedgerDescriptionPlaceholder: "可选",
  createLedgerPrivate: "私有",
  createLedgerTemplate: "模板",
  createLedgerTemplateStarter: "入门",
  ...
  createLedgerEmptyBody: "创建一个账本，或发现公开示例。",
  createLedgerEmptyCreate: "创建",
  createLedgerEmptyDiscover: "发现",
