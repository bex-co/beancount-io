 ...
 * `offset`; `total` bounds the end of the list. `skip` holds the read back
 * while the caller still decides its options (e.g. which `conversion`).
 */
