...
Conventions (hierarchy, sizing rule, quality gate, standing closing tasks, templates) live canonically in [`../../.agents/skills/pm/SKILL.md`](../../.agents/skills/pm/SKILL.md).
