...
- [ ] **m34** — Offline-tolerant cold start: persist the Apollo cache (8 tasks) ← from `/pm-brainstorm` 2026-08-19, materialized in the same hand-off; sequenced after m33 — feature before infrastructure
