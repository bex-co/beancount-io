...
- If $ARGUMENTS refers to this repo, read the relevant docs/code first — start with the root `AGENTS.md` for the package map, the scoped `<package>/AGENTS.md` for the package's architecture, and `docs/adrs/` for recorded decisions. Don't diagram from guesswork.
