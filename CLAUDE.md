...
| `cli/`             | active | `beancount-io` — the `bea` command: directives, bean-check/format, BQL queries, reports, local-ledger ask (Python, Typer) — includes vendored `fava` reporting library                                     |
