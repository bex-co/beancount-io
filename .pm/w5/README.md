...
- [ ] **m4** — [Make real MCP agent journeys reproducible](./blocked/m4/README.md) (9 tasks) — **blocked:** needs a user decision on the local benchmark stack and billed runs. ← promoted core scope of [w2/009](../w2/009.md); user routed to w5 on 2026-09-12
