...
**Worker:** worker1 **Goal:** Catalan readers can recognize navigation, filters and journal controls without unrelated error/loading text **Status:** todo (t001–t004 done)
...
| t002 | Repair Catalan Journal message associations — **DONE** | 50m | t001 |
