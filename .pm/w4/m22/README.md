...
**Worker:** worker1 **Goal:** Public source and entry readers expose their actual read-only state while authorized editors retain editing behavior. **Status:** todo (t001–t003 done)
...
| [t002](./done/t002.md) | Cover Entry Context and read-only preview consumers — **DONE** | 25m | t001 |
