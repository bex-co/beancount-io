...
**Worker:** worker1 **Goal:** Ukrainian stops being the worst-rendering locale in the product — no screen shows half-translated labels like `Вocuments` or `Рахунок Journal` **Status:** todo

## Tasks (in order)

| id   | title                                                    | est | depends_on   |
| ---- | -------------------------------------------------------- | --- | ------------ |
| t001 | Repair the `auth` and `collaboration` catalogs             | 30m | —            |
...
| t006 | Repair the `ledger-data` catalogs                          | 30m | w4/m24/t005  |
| t007 | Repair the `ledger-editor` catalogs                        | 20m | w4/m24/t006  |
