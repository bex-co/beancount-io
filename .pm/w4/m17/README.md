...
**Worker:** worker1 **Goal:** opening a newly filtered ledger reaches that ledger and Back restores the search, even before the URL debounce settles **Status:** todo (t001–t004 done)
