...
**Worker:** worker1 **Goal:** Let readers identify a table's account, currency pair, report purpose or option family through accessible table navigation. **Status:** todo

## Tasks (in order)

| id | title | est | depends_on |
| --- | --- | --- | --- |
| [t001](./t001.md) | Name Budget and Commodities histories | 35m | — |
| [t002](./t002.md) | Associate Statistics and Settings tables with their headings | 40m | t001 |
