...
**Worker:** worker1 **Goal:** every `bea` exit code matches what actually happened on disk — exit 0 means the documented effect occurred and the ledger still checks, and nonzero means nothing was written or the partial writes are named **Status:** todo (t001, t002, t003, t004 done)
...
| t005 | Stop query one-shots exiting 0 on nothing | 45m | — |
| t006 | Make "did nothing" a failure for treeify, ingest, and format | 30m | — |
| t007 | Mark plugin-synthesized directives as generated, not on disk | 45m | — |
