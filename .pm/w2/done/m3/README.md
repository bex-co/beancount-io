...
**Worker:** worker2 **Goal:** a SaaS refugee with a CSV export goes from zero to a bean-check-clean ledger — mapped accounts, opening balances, migration report — running in Fava **Status:** done

## Tasks (in order)

| id   | title                                                     | est  | depends_on |
| ---- | --------------------------------------------------------- | ---- | ---------- |
| t001 | SKILL.md skeleton: triggers/skip, composes beancount-init — **DONE** | 45m  | —          |
| t002 | Per-source references: Mint, Monarch, QBO formats + mapping — **DONE** | 1.5h | t001       |
| t003 | Verification: counts/balances vs source, unmapped report — **DONE** | 45m  | t002       |
| t004 | Evals: fixture exports + expected ledgers — **DONE** | 1h   | t003       |
