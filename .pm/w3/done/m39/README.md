...
**Worker:** worker3 **Goal:** a screen-reader or keyboard user can jump straight to the ledger navigation, or straight past it to the content, on every dashboard route **Status:** done
...
| --- | --- | --- | --- |
| t001 | Wrap the ledger and dashboard sidebars in labelled navigation landmarks | 40m | — | — **DONE**
| t002 | Add a skip-to-content link to the dashboard shell | 35m | t001 | — **DONE**
| t003 | Verify the navigation adoption surface | 15m | t002 | — **DONE**
| t004 | Simplify the landmark and skip-link wiring | 10m | t003 | — **DONE**
| t005 | Test landmarks and skip-link behavior | 40m | t003 | — **DONE**
| t006 | Close and archive the navigation landmark milestone | 10m | t004, t005 | — **DONE**
