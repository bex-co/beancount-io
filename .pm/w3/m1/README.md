...
- **Expected outcome:** Mobile users can see budget-vs-actual without opening the web dashboard; measured by `page_view_budget` and `budget_panel_see_all` analytics landing in the funnel.
