...
- Conventions — mission pillars, hierarchy, sizing rule, quality gate, templates — live canonically in [`.agents/skills/pm/SKILL.md`](../.agents/skills/pm/SKILL.md).
...
This board is public and part of the project's face — write everything in it for community consumption.
