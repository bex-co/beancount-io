...
const ruSeo: Record<string, TranslationEntry> = {
  ...
  "seo.ledgerEntry.description": {
    message:
      "Откройте общую запись в {ledgerName}. Показывает авторизованный исходный контекст.",
    description:
      "Entry page meta description — generic; never include entry source",
  },
  "seo.ledgerEntry.title": {
    message: "Запись - {ledgerName}",
  ...
  "seo.ledgerFiles.description": {
    message: "Просматривайте бухгалтерские файлы Beancount для {ledgerName}.",
  ...
  "seo.welcome.description": {
    message:
      "Добро пожаловать в Beancount! Начните вести учёт в текстовом формате и управлять финансами.",
