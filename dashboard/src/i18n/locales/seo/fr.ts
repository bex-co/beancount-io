...
const frSeo: Record<string, TranslationEntry> = {
  ...
  "seo.forgotPassword.description": {
    message:
      "Réinitialisez le mot de passe de votre compte Beancount en saisissant votre adresse e-mail.",
  ...
  "seo.ledgerCollaborators.description": {
    message:
      "Gérez les collaborateurs de {ledgerName}. Invitez des utilisateurs et contrôlez les autorisations d'accès.",
    description: "Collaborators page meta description",
  },
  "seo.ledgerCollaborators.title": {
    message: "Collaborateurs - {ledgerName}",
  ...
  "seo.ledgerFiles.description": {
    message:
      "Modifiez les fichiers du livre comptable pour {ledgerName}. Visualisez et modifiez vos fichiers comptables Beancount.",
  ...
  "seo.login.description": {
    message:
      "Connectez-vous à votre compte Beancount pour gérer vos livres comptables et registres financiers.",
  ...
  "seo.settingsIndex.description": {
    message:
      "Gérez les paramètres, préférences et configurations de votre compte Beancount.",
  ...
  "seo.signUp.description": {
    message:
      "Créez votre compte Beancount gratuit pour commencer à suivre vos finances avec la comptabilité en texte brut.",
