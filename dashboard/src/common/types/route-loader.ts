 ...
 * @example
 * ```ts
 * export const myLoader: RouteLoader<"/ledger/$ledgerOwner/$ledgerName/journal"> = async ({ params, context }) => {
 *   // params.ledgerOwner, params.ledgerName — typed
 ...
 * @example
 * ```ts
 * export const myBeforeLoader: RouteBeforeLoader<"/ledger/$ledgerOwner/$ledgerName/journal"> = ({ params, context, search }) => {
 *   // params.ledgerOwner, params.ledgerName — typed
 *   // context.client — typed from RouterContext
