...
import { SidebarMenuSubButton, SidebarProvider, useSidebar } from "../sidebar";
...
describe("Sidebar", () => {
  ...
  describe("SidebarMenuSubButton", () => {
    it("fills the nested navigation row", () => {
      render(
        <SidebarMenuSubButton asChild>
          <button type="button">Nested destination</button>
        </SidebarMenuSubButton>,
      );

      expect(
        screen.getByRole("button", { name: "Nested destination" }),
      ).toHaveClass("w-full");
    });
  });
});
