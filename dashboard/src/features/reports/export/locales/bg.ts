...
export default createExportLocale({
  ...
  netCashOperating: "Нетен паричен поток от оперативна дейност",
  netCashInvesting: "Нетен паричен поток от инвестиционна дейност",
  netCashFinancing: "Нетен паричен поток от финансова дейност",
  netChangeInCash: "Нетна промяна в паричните средства и еквиваленти",
  openingCash: "Парични средства и еквиваленти в началото на периода",
  closingCash: "Парични средства и еквиваленти в края на периода",
  ...
  inferredAsOfDateNotice:
    "Не е избрана изрична дата на отчета. Отчетът включва цялата счетоводна дейност до {asOfDate} включително.",
  ...
  cashFlowClassificationNotice:
    "Оперативната, инвестиционната и финансовата дейност се определят по вида и името на сметките без декларирана cash-flow-role; сметките с такава декларация се класифицират както е записано.",
  cashFlowCashEquivalentsNotice:
    "Наборът от парични средства и еквиваленти се определя по имената на сметките (разплащателни, спестовни и подобни парични сметки). Прегледайте включените сметки преди външна употреба.",
