...
@ingest_app.command("identify", context_settings=_EXTRA)
...
@ingest_app.command("extract", context_settings=_EXTRA)
...
@ingest_app.command("archive", context_settings=_EXTRA)
