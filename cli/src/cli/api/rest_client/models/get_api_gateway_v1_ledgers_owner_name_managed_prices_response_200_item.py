...
from ..models.get_api_gateway_v1_ledgers_owner_name_managed_prices_response_200_item_freshness import (
    GetApiGatewayV1LedgersOwnerNameManagedPricesResponse200ItemFreshness,
)

if TYPE_CHECKING:
    from ..models.get_api_gateway_v1_ledgers_owner_name_managed_prices_response_200_item_included_from_item import (
        GetApiGatewayV1LedgersOwnerNameManagedPricesResponse200ItemIncludedFromItem,
    )


T = TypeVar("T", bound="GetApiGatewayV1LedgersOwnerNameManagedPricesResponse200Item")


@_attrs_define
class GetApiGatewayV1LedgersOwnerNameManagedPricesResponse200Item:
    """
    Attributes:
        url (str):
        alias (str):
        included_from (list[GetApiGatewayV1LedgersOwnerNameManagedPricesResponse200ItemIncludedFromItem]):
        commodity (None | str):
        quote (None | str):
        source (None | str):
        revision (None | str):
        ...
        freshness (GetApiGatewayV1LedgersOwnerNameManagedPricesResponse200ItemFreshness):
        error (None | str):
        shadowed_count (int):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_api_gateway_v1_ledgers_owner_name_managed_prices_response_200_item_included_from_item import (
            GetApiGatewayV1LedgersOwnerNameManagedPricesResponse200ItemIncludedFromItem,  # noqa: PLC0415
        )
        ...
        for included_from_item_data in _included_from:
            included_from_item = GetApiGatewayV1LedgersOwnerNameManagedPricesResponse200ItemIncludedFromItem.from_dict(
        ...
        freshness = GetApiGatewayV1LedgersOwnerNameManagedPricesResponse200ItemFreshness(d.pop("freshness"))
        ...
        get_api_gateway_v1_ledgers_owner_name_managed_prices_response_200_item = cls(
            url=url,
            alias=alias,
        ...
        get_api_gateway_v1_ledgers_owner_name_managed_prices_response_200_item.additional_properties = d
        return get_api_gateway_v1_ledgers_owner_name_managed_prices_response_200_item
