...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api-gateway/v1/ledgers/{owner}/{name}/bank-transactions/suggested-categories".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Suggest a ledger account per unsynced transaction

     Category suggestions drawn from the ledger's own history — what an importer should propose before
    asking.
