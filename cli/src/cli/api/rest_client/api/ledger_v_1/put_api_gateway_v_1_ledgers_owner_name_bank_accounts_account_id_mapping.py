...
from ...models.bank_account_mapping import BankAccountMapping
from ...models.put_api_gateway_v1_ledgers_owner_name_bank_accounts_account_id_mapping_dry_run import (
...
def _get_kwargs(
    ...
    account_id: str,
    *,
    body: BankAccountMapping | Unset = UNSET,
    dry_run: PutApiGatewayV1LedgersOwnerNameBankAccountsAccountIdMappingDryRun | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api-gateway/v1/ledgers/{owner}/{name}/bank-accounts/{account_id}/mapping".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Map a bank account to a ledger account
     ...
     Sets which ledger account this bank account's transactions book against. No `dry_run`: the preview
    would only echo the value you sent.
    ...
    Args:
        ...
        dry_run (PutApiGatewayV1LedgersOwnerNameBankAccountsAccountIdMappingDryRun | Unset):
        body (BankAccountMapping | Unset):
