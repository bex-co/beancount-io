...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api-gateway/v1/ledgers/{owner}/{name}/payees".format(
...
def sync_detailed(
    ...
    *,
    ...
    """List payees used in the ledger

     Every payee that appears on a transaction. The list a client should reconcile against before
    inventing a new payee string.
