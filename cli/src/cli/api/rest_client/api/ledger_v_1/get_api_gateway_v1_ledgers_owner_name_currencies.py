...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api-gateway/v1/ledgers/{owner}/{name}/currencies".format(
...
def sync_detailed(
    ...
    *,
    ...
    """List currencies used in the ledger

     Every currency the ledger's postings are denominated in. Writing an entry in a currency absent from
    this list is usually a typo.
