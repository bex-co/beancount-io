...
from ...models.post_api_gateway_v1_ledgers_owner_name_banks_item_id_reconcile_dry_run import (
...
def _get_kwargs(
    ...
    item_id: str,
    *,
    dry_run: PostApiGatewayV1LedgersOwnerNameBanksItemIdReconcileDryRun | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api-gateway/v1/ledgers/{owner}/{name}/banks/{item_id}/reconcile".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Re-read which accounts the bank shares

     Adds accounts the bank now shares and removes ones it no longer does. `dry_run=true` returns that
    ...
    Args:
        ...
        dry_run (PostApiGatewayV1LedgersOwnerNameBanksItemIdReconcileDryRun | Unset): Validate and
