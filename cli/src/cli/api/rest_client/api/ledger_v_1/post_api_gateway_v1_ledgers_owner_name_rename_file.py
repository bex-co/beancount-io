...
from ...models.post_api_gateway_v1_ledgers_owner_name_rename_file_body import (
    PostApiGatewayV1LedgersOwnerNameRenameFileBody,
)
from ...models.post_api_gateway_v1_ledgers_owner_name_rename_file_response_200 import (
...
def _get_kwargs(
    ...
    name: str,
    *,
    body: PostApiGatewayV1LedgersOwnerNameRenameFileBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api-gateway/v1/ledgers/{owner}/{name}/rename-file".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PostApiGatewayV1LedgersOwnerNameRenameFileResponse200.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (PostApiGatewayV1LedgersOwnerNameRenameFileBody | Unset):
...
def sync(
    ...
    *,
    ...
    Returns:
        PostApiGatewayV1LedgersOwnerNameRenameFileResponse200 | V1Error
    """
