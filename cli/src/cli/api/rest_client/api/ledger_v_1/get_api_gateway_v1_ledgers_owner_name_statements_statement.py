...
def _get_kwargs(
    owner: str,
    name: str,
    statement: GetApiGatewayV1LedgersOwnerNameStatementsStatementStatement,
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api-gateway/v1/ledgers/{owner}/{name}/statements/{statement}".format(
            owner=quote(str(owner), safe=""),
            name=quote(str(name), safe=""),
            statement=quote(str(statement), safe=""),
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        statement (GetApiGatewayV1LedgersOwnerNameStatementsStatementStatement): Which statement
            to render Example: balance-sheet.
        account (str | Unset):
        filter_ (str | Unset):
