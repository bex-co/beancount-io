...
from ...models.get_api_gateway_v1_public_keys_response_200_item import GetApiGatewayV1PublicKeysResponse200Item
...
) -> V1Error | list[GetApiGatewayV1PublicKeysResponse200Item] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = GetApiGatewayV1PublicKeysResponse200Item.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[V1Error | list[GetApiGatewayV1PublicKeysResponse200Item]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """List the caller's SSH public keys
     ...
     Administrative account operation. Uses the authenticated user, including for ledger-pinned
    credentials. Pagination is passed to the key service.
...
def sync(
    *,
    ...
    Returns:
        V1Error | list[GetApiGatewayV1PublicKeysResponse200Item]
    """
