...
from ...models.get_api_gateway_v1_ledgers_owner_name_collaborators_response_200_item import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api-gateway/v1/ledgers/{owner}/{name}/collaborators".format(
...
) -> V1Error | list[GetApiGatewayV1LedgersOwnerNameCollaboratorsResponse200Item] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = GetApiGatewayV1LedgersOwnerNameCollaboratorsResponse200Item.from_dict(
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[V1Error | list[GetApiGatewayV1LedgersOwnerNameCollaboratorsResponse200Item]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """List ledger collaborators

     Requires ledger.admin and current permission to inspect collaborators. Defaults to page 1 and limit
    10.

    Args:
        owner (str): Ledger owner's username Example: alice.
        name (str): Ledger (repository) name Example: main-ledger.
        page (float | None | Unset):  Default: 1.0.
...
def sync(
    ...
    *,
    ...
    Returns:
        V1Error | list[GetApiGatewayV1LedgersOwnerNameCollaboratorsResponse200Item]
    """
