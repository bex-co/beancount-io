...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api-gateway/v1/ledgers/{owner}/{name}/latest-commit".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Read the latest commit on a ledger branch
    ...
    Args:
        ...
        branch_name (str | Unset):  Default: 'main'.
