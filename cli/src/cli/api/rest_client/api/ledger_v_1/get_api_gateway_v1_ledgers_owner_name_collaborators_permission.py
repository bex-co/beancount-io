...
from ...models.get_api_gateway_v1_ledgers_owner_name_collaborators_permission_response_200 import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api-gateway/v1/ledgers/{owner}/{name}/collaborators/permission".format(
...
) -> GetApiGatewayV1LedgersOwnerNameCollaboratorsPermissionResponse200 | V1Error | None:
    if response.status_code == 200:
        response_200 = GetApiGatewayV1LedgersOwnerNameCollaboratorsPermissionResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApiGatewayV1LedgersOwnerNameCollaboratorsPermissionResponse200 | V1Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Read a ledger collaborator's permission
...
def sync(
    ...
    *,
    ...
    Returns:
        GetApiGatewayV1LedgersOwnerNameCollaboratorsPermissionResponse200 | V1Error
    """
