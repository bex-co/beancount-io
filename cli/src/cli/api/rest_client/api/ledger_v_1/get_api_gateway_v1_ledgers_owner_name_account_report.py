...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api-gateway/v1/ledgers/{owner}/{name}/account-report".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        account_name (str): The account to report on Example: Expenses:Groceries.
