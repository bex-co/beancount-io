...
from ...models.get_api_gateway_v1_social_followers_response_200 import GetApiGatewayV1SocialFollowersResponse200
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api-gateway/v1/social/followers",
        "params": params,
    }
...
) -> GetApiGatewayV1SocialFollowersResponse200 | V1Error | None:
    if response.status_code == 200:
        response_200 = GetApiGatewayV1SocialFollowersResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetApiGatewayV1SocialFollowersResponse200 | V1Error]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        GetApiGatewayV1SocialFollowersResponse200 | V1Error
    """
