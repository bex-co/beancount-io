...
from ...models.delete_api_gateway_v1_ledgers_owner_name_banks_item_id_dry_run import (
...
def _get_kwargs(
    ...
    item_id: str,
    *,
    dry_run: DeleteApiGatewayV1LedgersOwnerNameBanksItemIdDryRun | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/api-gateway/v1/ledgers/{owner}/{name}/banks/{item_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Unlink a bank
     ...
     Severs the bank connection. `dry_run=true` reports what would be severed — the institution and every
    account — without doing it.
    ...
    Args:
        ...
        dry_run (DeleteApiGatewayV1LedgersOwnerNameBanksItemIdDryRun | Unset): Validate and report
