...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api-gateway/v1/ledgers/{owner}/{name}/attributes".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get the ledger's attributes

     Accounts, currencies, payees, and links as one document — the summary the other endpoints break out
    individually.
