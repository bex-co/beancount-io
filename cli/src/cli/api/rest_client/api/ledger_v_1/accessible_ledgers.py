...
from ...models.accessible_ledgers_response_200_item import AccessibleLedgersResponse200Item
...
) -> V1Error | list[AccessibleLedgersResponse200Item] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = AccessibleLedgersResponse200Item.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[V1Error | list[AccessibleLedgersResponse200Item]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        page (int | Unset): 1-based page number Example: 1.
        limit (int | Unset): Page size, at most 100 Example: 20.
...
def sync(
    *,
    ...
    Returns:
        V1Error | list[AccessibleLedgersResponse200Item]
    """
