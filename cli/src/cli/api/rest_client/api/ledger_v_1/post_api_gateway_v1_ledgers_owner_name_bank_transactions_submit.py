...
from ...models.bank_transaction_submission import BankTransactionSubmission
from ...models.post_api_gateway_v1_ledgers_owner_name_bank_transactions_submit_dry_run import (
...
def _get_kwargs(
    ...
    name: str,
    *,
    body: BankTransactionSubmission | Unset = UNSET,
    dry_run: PostApiGatewayV1LedgersOwnerNameBankTransactionsSubmitDryRun | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api-gateway/v1/ledgers/{owner}/{name}/bank-transactions/submit".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Write staged transactions into the ledger

     Appends the named transactions as beancount directives. `dry_run=true` runs every check and returns
    the exact entries that would be written.

    Args:
        owner (str): Ledger owner's username Example: alice.
        name (str): Ledger (repository) name Example: main-ledger.
        dry_run (PostApiGatewayV1LedgersOwnerNameBankTransactionsSubmitDryRun | Unset): Validate
            and report what would change, without changing anything.
        body (BankTransactionSubmission | Unset):
