...
from ...models.update_ledger_body import UpdateLedgerBody
from ...models.update_ledger_response_200 import UpdateLedgerResponse200
...
def _get_kwargs(
    ...
    name: str,
    *,
    body: UpdateLedgerBody | Unset = UNSET,
) -> dict[str, Any]:
...
) -> UpdateLedgerResponse200 | V1Error | None:
    if response.status_code == 200:
        response_200 = UpdateLedgerResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[UpdateLedgerResponse200 | V1Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Update a ledger
     ...
     Update ledger name, description, or visibility. Requires current administrative authority over the
    addressed ledger and respects the credential pin.

    Args:
        owner (str): Ledger owner's username Example: alice.
        name (str): Ledger (repository) name Example: main-ledger.
        body (UpdateLedgerBody | Unset):
...
def sync(
    ...
    *,
    ...
    Returns:
        UpdateLedgerResponse200 | V1Error
    """
