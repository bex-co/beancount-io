...
from ...models.post_api_gateway_v1_ledgers_owner_name_entry_source_delete_many_body import (
    PostApiGatewayV1LedgersOwnerNameEntrySourceDeleteManyBody,
)
from ...models.post_api_gateway_v1_ledgers_owner_name_entry_source_delete_many_response_200 import (
...
def _get_kwargs(
    ...
    name: str,
    *,
    body: PostApiGatewayV1LedgersOwnerNameEntrySourceDeleteManyBody | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api-gateway/v1/ledgers/{owner}/{name}/entry-source/delete-many".format(
...
) -> PostApiGatewayV1LedgersOwnerNameEntrySourceDeleteManyResponse200 | V1Error | None:
    if response.status_code == 200:
        response_200 = PostApiGatewayV1LedgersOwnerNameEntrySourceDeleteManyResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PostApiGatewayV1LedgersOwnerNameEntrySourceDeleteManyResponse200 | V1Error]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (PostApiGatewayV1LedgersOwnerNameEntrySourceDeleteManyBody | Unset):
...
def sync(
    ...
    *,
    ...
    Returns:
        PostApiGatewayV1LedgersOwnerNameEntrySourceDeleteManyResponse200 | V1Error
    """
