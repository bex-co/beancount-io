...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V1Error | list[ApiKey] | None:
...
def sync_detailed(
    *,
    ...
    """List your API keys
     ...
     Every key you have minted, newest first, including revoked and expired ones. Keys are shown by
    prefix — the key itself was returned once, when it was created.
