...
from ..beans.funcs import get_position
from ..helpers import BeancountError
from ..util.date import END_OF_YEAR, parse_fye_string
...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from ..util.date import FiscalYearEnd
...
class NotARegularExpressionError(TypeError):
    def __init__(self, value: str) -> None:
        super().__init__(f"Should be a regular expression: '{value}'.")


class NotAStringOptionError(TypeError):
    def __init__(self, key: str) -> None:
        super().__init__(f"Expected string value for option `{key}`")


class UnknownLocaleOptionError(ValueError):
    def __init__(self, value: str) -> None:
        super().__init__(f"Unknown locale: '{value}'.")


class UnsupportedLanguageOptionError(ValueError):
    def __init__(self, value: str) -> None:
        super().__init__(f"Fava has no translations for: '{value}'.")


class InvalidFiscalYearEndOptionError(ValueError):
    def __init__(self, value: str) -> None:
...
class FavaOptions:
    ...
    def set_insert_entry(self, value: str, date: datetime.date, filename: str, lineno: int) -> None:
