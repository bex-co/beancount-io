...
skills/
  .claude/
    skills/
      ...
      beancount-init/         Scaffold a new beancount + fava ledger repo (builds on `bea init`)
        SKILL.md
...
| `beancount-init`                  | Scaffold a fresh `main.bean` + Fava + uv project from an empty directory; builds on `bea init` when installed, otherwise writes the same thirteen-account template. Triggers on `/beancount-init` or "set up a new beancount repo".                                                                                                                                                                                                                                                                                                                                                                                             |
...
| `mobile-release`                  | `/mobile-release` — summarize changes since the previous mobile release, bump versions, localize notes, stage and verify Apple metadata, ship, and follow iOS App Review and Google Play production release through verified status.                                                                                                                                                                                                                                                                                                  |
